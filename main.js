...
case userMessage.startsWith('.pair'):
    await pairCommand(sock, chatId, message, userMessage.replace('.pair', '').trim());
    commandExecuted = true;
    break;
case userMessage.startsWith('.autovoice'):
    await autovoiceCommand(sock, chatId, message);
    commandExecuted = true;
    break;
// Add this case in your switch statement with other commands
